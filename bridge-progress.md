...
Unit 1 established the mathematical foundation for the NYU Tandon Bridge Program, covering core algebra, functions, graphs, polynomial and rational functions, and exponential and logarithmic functions.
...
### Module 1, Lesson 1.4: Implication & Contrapositive

**Status:** Completed

**Official Knowledge Check DM1.4:** 3/3, 100%, Attempt 1
### Work Completed

- Reviewed the NYU Lesson 1.4 lesson page
- Watched the lecture video
- Reviewed assigned textbook Section 1.2 on implications
- Practiced implication, converse, inverse, contrapositive, and biconditional statements
- Practiced necessary and sufficient condition wording
- Practiced implication equivalences and truth-table verification
- Completed the official Knowledge Check

### Practice Results

- Core Lesson 1.4 review: 15/15
- Mixed review: 16/20
- Targeted if/only-if and necessary/sufficient drill: 8/8
- Final mixed Lesson 1.4 check: 10/10
- Official DM1.4 Knowledge Check: 3/3, 100%, Attempt 1
### Concepts Practiced
...
- Original implication is logically equivalent to its contrapositive
...
- An implication is false only when the left side is true and the right side is false.
- The contrapositive has the same truth value as the original implication.
- The converse and inverse are related to each other, but they are not automatically equivalent to the original implication.
- `P if Q` translates as `Q -> P`.
- `P only if Q` translates as `P -> Q`.
- For `not(P -> Q)`, calculate the inside implication first, then apply the outside NOT.
### Mistakes Corrected

- Improved accuracy with English wording for if, only-if, necessary, and sufficient.
- Corrected one necessary/sufficient reversal during mixed practice.
- Clarified the difference between a truth-table column and an equivalent expression.
- Refreshed Identity versus Universal Bound during the Module 1 wrap-up.
### Reflection

This lesson connected symbolic logic to English wording. The biggest improvement came from slowing down translations before solving: deciding which statement is the condition, which statement is the result, and whether the wording says "if" or "only if." By the end of the lesson, I could build the converse, inverse, and contrapositive without relying only on multiple-choice answers.

---

### Module 1: Logic Wrap-Up
...
- Biconditionals
- Logic-law simplification

### Evidence

- Completed Lessons 1.1 through 1.4
- Earned 100% on official Knowledge Checks for Lessons 1.1, 1.2, 1.3, and 1.4
- Completed cumulative review and corrected weak areas
- Refreshed implication equivalences and Identity versus Universal Bound

### Reflection

Module 1 built the foundation for discrete math by moving from simple statements to compound logical expressions, truth tables, equivalence, DeMorgan's Laws, implication, and biconditional reasoning. The main lesson was to work one step at a time, name the rule being used, and verify the result instead of guessing from memory.
